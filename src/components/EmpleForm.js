...
import imagen from "./img/empleado1.png"
import './style.css'
const EmpleForm = (props) => {
                ...
                <div class="signup-form" autoComplete="off" onSubmit={submitir}>
                    ...
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="tipo" name="tipo" value={values.tipo} onChange={handleInputChange}/>
                        </div>
                        <div class="form-group">
                            <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <input type="text" placeholder="universidad  " name="universidad" value={values.universidad} onChange={handleInputChange}/>
                        </div>
                        <div class="form-group">
                            <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <input type="number" placeholder="celular " name="celular" value={values.celular} onChange={handleInputChange}/>
                        </div>
